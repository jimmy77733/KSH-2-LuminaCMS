...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-zinc-50 px-4">
      ...
      >
        <h1 className="text-xl font-semibold tracking-tight">LuminaCMS 登入</h1>
        ...
        <button
          type="submit"
          disabled={loading}
          className="flex w-full items-center justify-center rounded-md bg-black px-3 py-2 text-sm font-medium text-white hover:bg-zinc-800 disabled:cursor-not-allowed disabled:opacity-70"
        >
          {loading ? "登入中..." : "登入"}
        </button>
