...
export const Galaxy: React.FC<GalaxyProps> = ({
  ...
  useEffect(() => {
    ...
    function onMouseMove(e: MouseEvent) {
      ...
      targetMouse.current = { x: (e.clientX - rect.left) / rect.width, y: 1 - (e.clientY - rect.top) / rect.height };
      targetActive.current = 1.0;
    }
    function onMouseLeave() { targetActive.current = 0.0; }
  ...
  return (
    <div
      ref={ctnRef}
      className={className}
      style={{ width: "100%", height: "100%", position: "relative", background: "#000010" }}
    />
  );
};
